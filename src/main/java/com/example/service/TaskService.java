 ...
 * <p>
 * TaskDto carries two Jackson annotations, so this is not a perfectly clean
 * layer split. That is a smaller price than a detached-entity trap that only
 * fires once someone adds a relationship.
 */
@Service
