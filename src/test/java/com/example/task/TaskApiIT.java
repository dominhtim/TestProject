...
class TaskApiIT {
    ...
    @Test
    void shouldRejectAnUnknownSortPropertyWithProblemDetail() {
        restClient.get().uri(API_V1_TASKS + "?sort=nonexistentField")
                .exchange()
                .expectStatus().isBadRequest()
                .expectBody()
                .jsonPath("$.title").isEqualTo("Invalid sort property")
                .jsonPath("$.property").isEqualTo("nonexistentField");
    }
